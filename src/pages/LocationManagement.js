...
import { Typography, Container, Box, Button, List, ListItem, ListItemText, Dialog, DialogTitle, DialogContent, DialogActions, Select, MenuItem } from '@mui/material';
...
const LocationManagement = () => {
  ...
  const handleMoveComputer = async () => {
    const { error } = await supabase
      .from('computers')
      .update({ location_store: targetLocation, location_column: 1, location_level: 1 }) // 移动到目标库位的第1列第1层
